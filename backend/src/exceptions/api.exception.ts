...
export enum ErrorMessage {
  ...
  WRONGUPASSWORD = 'Error generated by service: Password wrong, please check the password.',
  USERNOTFOUND = 'Error generated by DB query: User not found via the provided user id.',
  DUPLICATEYSER = 'Error generated by DB query: Username already exists, please change a username.',
